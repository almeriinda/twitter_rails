...
ActiveRecord::Schema.define(version: 2021_10_24_134101) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["followers_id"], name: "index_notifications_on_followers_id"
  end
  ...
  add_foreign_key "notifications", "followers", column: "followers_id"
